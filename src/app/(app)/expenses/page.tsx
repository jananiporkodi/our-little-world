...
import { getExpenses, getSettlements, getPartnerNames } from "@/lib/data";
...
export default async function ExpensesPage() {
  const [expenses, settlements, partnerNames] = await Promise.all([getExpenses(), getSettlements(), getPartnerNames()]);
